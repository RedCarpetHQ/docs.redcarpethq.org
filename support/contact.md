...
Get in touch with the RedCarpetHQ team.
...
**Telegram**  
📱 [RedCarpetHQ Community](https://t.me/redcarpethq)  
...
- Campaign/token address (if applicable)
...
- Wallet address
- Project synopsis
- Previous work (IMDb links)
- Budget and timeline
- Supporting documents

See [Screening Process](../getting-started/screening-process.md) for details.
...
| Email (Screening) | 3-7 days | Producer applications |
| Email (Security) | Immediate | Critical bugs |
...
**Note:** Blockchain operates 24/7. Smart contracts always available even when team is offline.
...
- LinkedIn: [RedCarpetHQ](https://linkedin.com/company/redcarpethq)
- Medium: [RedCarpetHQ Blog](https://medium.com/@redcarpethq)
- YouTube: [RedCarpetHQ](https://youtube.com/@redcarpethq)
...
- Include "SECURITY" for security issues
...
Before contacting support, check our [FAQ](faq.md) - your question may already be answered!
